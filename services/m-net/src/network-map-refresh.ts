...
import type { ProfileEvents, ListMembers } from './profile-workflow-types.ts'
...
export function createNetworkMapRefresher(
  ...
  materialize: (
    ...
    profileVersion: MNetProfileVersionFromSchema,
    correlationId: string
  ) => Promise<MaterializedMembers | import('./profile-workflow-types.ts').ProfileWorkflowFailure>
