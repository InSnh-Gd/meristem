...
const permissions = [
  ...
  ['node:switch-role', 'switch an existing agent node between stem and leaf roles'],
  ['node:disable', 'disable an existing agent node'],
  ['node:isolate', 'isolate an existing agent node from peer paths'],
  ['node:recover', 'mark an existing controlled node for recovery'],
  ...
  ['network:delete', 'delete logical networks and remove members'],
