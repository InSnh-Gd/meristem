...
import { approvalProfileFacadeRoutes } from './routes/facade/approval-profile-facade.ts'
import { config, configApplyAck } from './routes/config/config.ts'
import { deployFacadeRoutes } from './routes/facade/deploy-facade.ts'
import { globalDefaultsFacadeRoutes } from './routes/facade/global-defaults-facade.ts'
import { healthRoutes } from './routes/health/health.ts'
import { identity } from './routes/identity/identity.ts'
import { logsRoutes } from './routes/log/logs.ts'
import { networksRoutes } from './routes/network/networks.ts'
import { nodesRoutes } from './routes/node/nodes.ts'
import { policyRoutes } from './routes/policy/policy.ts'
import { projectionRoutes } from './routes/projection/projection.ts'
import { secretReference, secrets } from './routes/secrets/secrets.ts'
import { servicesRoutes } from './routes/service/services.ts'
